   ...
   public class Constants
    {
        ...
        public const string FILE_HoaDonBanLe = "BK_HoaDonBanLe";
        public const string FILE_HoaDonBanLeCT = "BK_HoaDonBanLeCT";
        public const string FILE_HoaDonBanSi = "BK_HoaDonBanSi";
        public const string FILE_HoaDonBanSiCT = "BK_HoaDonBanSiCT";
        public const string FILE_PhieuChiTien = "BK_PhieuChiTien";
        public const string FILE_PhieuNhapKho = "BK_PhieuNhapKho";
        public const string FILE_PhieuNhapKhoCT = "BK_PhieuNhapKhoCT";
        ...
        public const string FOLDER_EXCELS = "MauExcel";
