...
namespace QuanLyShopQuanAo
{
    public class ExcelExport
    {
        ...
        public const string T_HoaDonBanLe = "BK_HoaDonBanLe";
        public const string T_HoaDonBanLeCT = "BK_HoaDonBanLeCT";
        public const string T_HoaDonBanSi = "BK_HoaDonBanSi";
        public const string T_HoaDonBanSiCT = "BK_HoaDonBanSiCT";
        public const string T_PhieuChiTien = "BK_PhieuChiTien";
        public const string T_PhieuNhapKho = "BK_PhieuNhapKho";
        public const string T_PhieuNhapKhoCT = "BK_PhieuNhapKhoCT";
        #endregion
        ...
        private const string V_TuNgayDenNgay = "%TuNgayDenNgay";
        // Phieu nhap kho
        private const string V_MaPhieuNhap = "%MaPhieuNhap";
        private const string V_NgayLapPhieu = "%NgayLapPhieu";
        private const string V_NhanVienLap = "%MaNV";
        private const string V_MaLo = "%MaLo";
        private const string V_MaNCC = "%MaNCC";
        private const string V_MoTa = "%MoTa";
        // Chi tiet phieu nhap kho
        private const string V_MaHang = "%MaHang";
        private const string V_SoLuong = "%SoLuong";
        private const string V_GiaVon = "%GiaVon";
        private const string V_ThanhTien = "%ThanhTien";
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_PhieuNhapKho:
                    arrByte = File.ReadAllBytes("BK_PhieuNhapKho.xlsx").ToArray();
                    break;

                case T_PhieuNhapKhoCT:
                    arrByte = File.ReadAllBytes("BK_PhieuNhapKhoCT.xlsx").ToArray();
                    break;
        ...
        */
        ...
        public bool ExportPhieuNhapKho(List<PhieuNhapKho> dataSource, DateTime dateStart, DateTime dateEnd, ref string filename, bool isPrintPreview)
        {
            // Check if data is null
            if (dataSource == null || (dataSource != null && dataSource.Count == 0))
            {
            ...
            // Create replacer
            Dictionary<string, string> replacer = new Dictionary<string, string>();
            // gán giá trị đầu: từ ngày đến ngày
            if(replacer != null)
            {
                string ngay = "Từ " + dateStart.ToString(Constants.DATE_PATTERN) + " đến " + dateEnd.ToString(Constants.DATE_PATTERN);
                replacer.Add(V_TuNgayDenNgay, ngay);
            }
            // gán report và return
            replacer.Add(V_MaPhieuNhap, "001");
            replacer.Add(V_NgayLapPhieu, "002");
            replacer.Add(V_NhanVienLap, "003");
            replacer.Add(V_MaLo, "004");
            replacer.Add(V_MaNCC, "005");
            replacer.Add(V_MoTa, "006");
            return OutSimpleReport(dataSource, replacer, "BK_PhieuNhapKho", isPrintPreview, ref filename);
        }

        public bool ExportPhieuNhapKhoCT(List<ChiTiet_PhieuNhapKho> dataSource, DateTime dateStart, DateTime dateEnd, ref string filename, bool isPrintPreview)
        {
            // Check if data is null
            if (dataSource == null || (dataSource != null && dataSource.Count == 0))
            {
            ...
            // gán report và return
            replacer.Add(V_MaPhieuNhap, "001");
            replacer.Add(V_MaHang, "002");
            replacer.Add(V_SoLuong, "003");
            replacer.Add(V_GiaVon, "004");
            replacer.Add(V_ThanhTien, "005");
            replacer.Add(V_MoTa, "006");
            return OutSimpleReport(dataSource, replacer, "BK_PhieuNhapKhoCT", isPrintPreview, ref filename);
        }
